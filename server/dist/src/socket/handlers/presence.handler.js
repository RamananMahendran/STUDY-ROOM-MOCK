import { addUserToRoom, removeUserFromRoom, getRoomUsers, getRoomState, mapSocketToUser, deleteSocketMapping, enforceRoomCapacity, setUserMediaState, } from '../../services/redis.service.js';
export const registerPresenceHandlers = (io, socket) => {
    ...
    const handleToggleMedia = async (data) => {
        try {
            const userId = socket.data.userId.toString();
